...
public class ThreadRoutePoNet implements Runnable{
	...
	public void run()
	{
		String filename = "/root/EFEED_Dataset/CHARACTERISTIC_POINTS.ASF";
	...
	public static void dispatchRoutePo(String file_name) throws IOException {
		...
		while((str=in.readLine())!=null) {
			...
			if(first=='-'&&second=='-')
			{
				...
				String rpd_str = gson.toJson(rpd);
				System.out.println("routepoint:"+rpd_str);
				producer.send(new ProducerRecord<String, String>("routepoint", rpd_str));
