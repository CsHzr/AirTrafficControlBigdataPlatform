...
public class RoutePoList {
	...
	private ConcurrentHashMap<String,RoutePoDb> m_sRoutePos;
	
	public RoutePoList()
	{
		routePointList = new CopyOnWriteArrayList<RoutePoDb>();
		m_sRoutePos=new ConcurrentHashMap<String,RoutePoDb>(1000);
	}
	...
	public ConcurrentHashMap<String, RoutePoDb> getRoutePoints() {return m_sRoutePos;}
